...
/opt/oomox/plugins/theme_oomox/gtk-theme/change_color.sh -o embark "$PWD/embark.oomox"
/opt/oomox/plugins/icons_papirus/change_color.sh -o embark "$PWD/embark.oomox"
